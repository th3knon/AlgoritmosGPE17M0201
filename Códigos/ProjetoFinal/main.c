...
int main() {
    ...
    while (1) {
        ...
        printf("2 - Listar: proprietarios com carro a diesel ano 2010 ou mais\n");
        printf("3 - Listar: placas de início J e final 0, 2, 4 ou 7\n");
      ...
      printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
        ...
        if (opcao == 1) {
            ...
            scanf(" %[^\n]s", proprietario);
            printf("Insira o combustivel (alcool, diesel ou gasolina): ");
            scanf("%s", combustivel);
          ...
          __fpurge(stdin);
            ...
            scanf("%s", chassi);
            printf("Inserir nome do novo prorpietário: ");
            scanf(" %[^\n]s", novo_proprietario);
